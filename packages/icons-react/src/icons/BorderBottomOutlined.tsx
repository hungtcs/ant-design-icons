...
import BorderBottomOutlinedSvg from '@ant-design/icons-svg/asn/BorderBottomOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BorderBottomOutlined);
