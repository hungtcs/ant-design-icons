...
import FilePptTwoToneSvg from '@ant-design/icons-svg/asn/FilePptTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FilePptTwoTone);
