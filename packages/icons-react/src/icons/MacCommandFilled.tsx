...
import MacCommandFilledSvg from '@ant-design/icons-svg/asn/MacCommandFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MacCommandFilled);
