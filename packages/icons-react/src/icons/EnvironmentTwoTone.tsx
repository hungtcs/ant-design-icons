...
import EnvironmentTwoToneSvg from '@ant-design/icons-svg/asn/EnvironmentTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(EnvironmentTwoTone);
