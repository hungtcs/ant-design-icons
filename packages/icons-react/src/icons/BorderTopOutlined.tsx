...
import BorderTopOutlinedSvg from '@ant-design/icons-svg/asn/BorderTopOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BorderTopOutlined);
