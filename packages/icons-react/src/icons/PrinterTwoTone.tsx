...
import PrinterTwoToneSvg from '@ant-design/icons-svg/asn/PrinterTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PrinterTwoTone);
