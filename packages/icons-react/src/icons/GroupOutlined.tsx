...
import GroupOutlinedSvg from '@ant-design/icons-svg/asn/GroupOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(GroupOutlined);
