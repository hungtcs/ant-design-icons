...
import WeiboCircleOutlinedSvg from '@ant-design/icons-svg/asn/WeiboCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(WeiboCircleOutlined);
