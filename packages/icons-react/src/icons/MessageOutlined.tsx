...
import MessageOutlinedSvg from '@ant-design/icons-svg/asn/MessageOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MessageOutlined);
