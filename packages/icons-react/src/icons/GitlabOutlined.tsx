...
import GitlabOutlinedSvg from '@ant-design/icons-svg/asn/GitlabOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(GitlabOutlined);
