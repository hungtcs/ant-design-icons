...
import PieChartOutlinedSvg from '@ant-design/icons-svg/asn/PieChartOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PieChartOutlined);
