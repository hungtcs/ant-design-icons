...
import FileImageTwoToneSvg from '@ant-design/icons-svg/asn/FileImageTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileImageTwoTone);
