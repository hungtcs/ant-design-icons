...
import AlipaySquareFilledSvg from '@ant-design/icons-svg/asn/AlipaySquareFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AlipaySquareFilled);
