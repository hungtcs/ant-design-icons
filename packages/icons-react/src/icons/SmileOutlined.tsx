...
import SmileOutlinedSvg from '@ant-design/icons-svg/asn/SmileOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SmileOutlined);
