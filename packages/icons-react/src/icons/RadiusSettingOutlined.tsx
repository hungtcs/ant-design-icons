...
import RadiusSettingOutlinedSvg from '@ant-design/icons-svg/asn/RadiusSettingOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RadiusSettingOutlined);
