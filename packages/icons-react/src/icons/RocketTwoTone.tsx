...
import RocketTwoToneSvg from '@ant-design/icons-svg/asn/RocketTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RocketTwoTone);
