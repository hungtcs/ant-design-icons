...
import MoneyCollectTwoToneSvg from '@ant-design/icons-svg/asn/MoneyCollectTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MoneyCollectTwoTone);
