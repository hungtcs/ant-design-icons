...
import UsergroupAddOutlinedSvg from '@ant-design/icons-svg/asn/UsergroupAddOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(UsergroupAddOutlined);
