...
import AccountBookOutlinedSvg from '@ant-design/icons-svg/asn/AccountBookOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AccountBookOutlined);
