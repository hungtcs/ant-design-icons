...
import OpenAIOutlinedSvg from '@ant-design/icons-svg/asn/OpenAIOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(OpenAIOutlined);
