...
import FieldNumberOutlinedSvg from '@ant-design/icons-svg/asn/FieldNumberOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FieldNumberOutlined);
