...
import AndroidFilledSvg from '@ant-design/icons-svg/asn/AndroidFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AndroidFilled);
