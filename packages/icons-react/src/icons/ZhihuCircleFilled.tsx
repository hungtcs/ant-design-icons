...
import ZhihuCircleFilledSvg from '@ant-design/icons-svg/asn/ZhihuCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ZhihuCircleFilled);
