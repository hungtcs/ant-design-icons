...
import SpotifyFilledSvg from '@ant-design/icons-svg/asn/SpotifyFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SpotifyFilled);
