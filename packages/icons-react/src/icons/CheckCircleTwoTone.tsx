...
import CheckCircleTwoToneSvg from '@ant-design/icons-svg/asn/CheckCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CheckCircleTwoTone);
