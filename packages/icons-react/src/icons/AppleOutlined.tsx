...
import AppleOutlinedSvg from '@ant-design/icons-svg/asn/AppleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AppleOutlined);
