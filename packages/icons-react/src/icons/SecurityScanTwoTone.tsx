...
import SecurityScanTwoToneSvg from '@ant-design/icons-svg/asn/SecurityScanTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SecurityScanTwoTone);
