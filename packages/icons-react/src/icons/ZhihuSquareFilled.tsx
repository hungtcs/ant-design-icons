...
import ZhihuSquareFilledSvg from '@ant-design/icons-svg/asn/ZhihuSquareFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ZhihuSquareFilled);
