...
import EuroCircleTwoToneSvg from '@ant-design/icons-svg/asn/EuroCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(EuroCircleTwoTone);
