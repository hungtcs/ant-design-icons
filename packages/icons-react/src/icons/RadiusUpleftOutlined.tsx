...
import RadiusUpleftOutlinedSvg from '@ant-design/icons-svg/asn/RadiusUpleftOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RadiusUpleftOutlined);
