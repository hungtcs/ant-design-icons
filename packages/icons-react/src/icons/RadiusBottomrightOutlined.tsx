...
import RadiusBottomrightOutlinedSvg from '@ant-design/icons-svg/asn/RadiusBottomrightOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RadiusBottomrightOutlined);
