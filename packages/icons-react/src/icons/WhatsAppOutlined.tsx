...
import WhatsAppOutlinedSvg from '@ant-design/icons-svg/asn/WhatsAppOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(WhatsAppOutlined);
