...
import DiscordFilledSvg from '@ant-design/icons-svg/asn/DiscordFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DiscordFilled);
