...
import ProfileTwoToneSvg from '@ant-design/icons-svg/asn/ProfileTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ProfileTwoTone);
