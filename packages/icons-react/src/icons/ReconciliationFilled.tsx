...
import ReconciliationFilledSvg from '@ant-design/icons-svg/asn/ReconciliationFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ReconciliationFilled);
