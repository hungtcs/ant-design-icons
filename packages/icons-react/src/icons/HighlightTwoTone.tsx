...
import HighlightTwoToneSvg from '@ant-design/icons-svg/asn/HighlightTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(HighlightTwoTone);
