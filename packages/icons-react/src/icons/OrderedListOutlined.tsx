...
import OrderedListOutlinedSvg from '@ant-design/icons-svg/asn/OrderedListOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(OrderedListOutlined);
