...
import HeartOutlinedSvg from '@ant-design/icons-svg/asn/HeartOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(HeartOutlined);
