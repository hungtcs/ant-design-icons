...
import BarcodeOutlinedSvg from '@ant-design/icons-svg/asn/BarcodeOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BarcodeOutlined);
