...
import BorderRightOutlinedSvg from '@ant-design/icons-svg/asn/BorderRightOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BorderRightOutlined);
