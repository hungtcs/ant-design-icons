...
import CloseCircleTwoToneSvg from '@ant-design/icons-svg/asn/CloseCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CloseCircleTwoTone);
