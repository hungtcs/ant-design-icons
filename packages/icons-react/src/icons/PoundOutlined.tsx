...
import PoundOutlinedSvg from '@ant-design/icons-svg/asn/PoundOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PoundOutlined);
