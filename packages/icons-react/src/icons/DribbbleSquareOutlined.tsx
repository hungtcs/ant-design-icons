...
import DribbbleSquareOutlinedSvg from '@ant-design/icons-svg/asn/DribbbleSquareOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DribbbleSquareOutlined);
