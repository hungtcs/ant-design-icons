...
import ControlFilledSvg from '@ant-design/icons-svg/asn/ControlFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ControlFilled);
