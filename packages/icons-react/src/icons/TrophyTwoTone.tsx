...
import TrophyTwoToneSvg from '@ant-design/icons-svg/asn/TrophyTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(TrophyTwoTone);
