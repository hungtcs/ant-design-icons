...
import CloudServerOutlinedSvg from '@ant-design/icons-svg/asn/CloudServerOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CloudServerOutlined);
