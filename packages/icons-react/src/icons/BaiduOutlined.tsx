...
import BaiduOutlinedSvg from '@ant-design/icons-svg/asn/BaiduOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BaiduOutlined);
