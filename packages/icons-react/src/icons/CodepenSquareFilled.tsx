...
import CodepenSquareFilledSvg from '@ant-design/icons-svg/asn/CodepenSquareFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CodepenSquareFilled);
