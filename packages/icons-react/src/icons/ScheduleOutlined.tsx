...
import ScheduleOutlinedSvg from '@ant-design/icons-svg/asn/ScheduleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ScheduleOutlined);
