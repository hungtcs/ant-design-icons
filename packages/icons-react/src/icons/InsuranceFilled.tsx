...
import InsuranceFilledSvg from '@ant-design/icons-svg/asn/InsuranceFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(InsuranceFilled);
