...
import CloseCircleOutlinedSvg from '@ant-design/icons-svg/asn/CloseCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CloseCircleOutlined);
