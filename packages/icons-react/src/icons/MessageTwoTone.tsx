...
import MessageTwoToneSvg from '@ant-design/icons-svg/asn/MessageTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MessageTwoTone);
