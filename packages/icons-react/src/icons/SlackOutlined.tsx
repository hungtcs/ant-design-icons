...
import SlackOutlinedSvg from '@ant-design/icons-svg/asn/SlackOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SlackOutlined);
