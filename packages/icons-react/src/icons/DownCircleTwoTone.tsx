...
import DownCircleTwoToneSvg from '@ant-design/icons-svg/asn/DownCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DownCircleTwoTone);
