...
import EuroCircleFilledSvg from '@ant-design/icons-svg/asn/EuroCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(EuroCircleFilled);
