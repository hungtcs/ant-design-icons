...
import BorderLeftOutlinedSvg from '@ant-design/icons-svg/asn/BorderLeftOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BorderLeftOutlined);
