...
import LeftCircleTwoToneSvg from '@ant-design/icons-svg/asn/LeftCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(LeftCircleTwoTone);
