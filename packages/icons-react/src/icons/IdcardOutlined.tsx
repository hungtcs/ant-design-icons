...
import IdcardOutlinedSvg from '@ant-design/icons-svg/asn/IdcardOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(IdcardOutlined);
