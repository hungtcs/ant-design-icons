...
import FunctionOutlinedSvg from '@ant-design/icons-svg/asn/FunctionOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FunctionOutlined);
