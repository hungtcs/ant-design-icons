...
import DashboardFilledSvg from '@ant-design/icons-svg/asn/DashboardFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DashboardFilled);
