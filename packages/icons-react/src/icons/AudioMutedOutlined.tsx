...
import AudioMutedOutlinedSvg from '@ant-design/icons-svg/asn/AudioMutedOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AudioMutedOutlined);
