...
import MacCommandOutlinedSvg from '@ant-design/icons-svg/asn/MacCommandOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MacCommandOutlined);
