...
import WomanOutlinedSvg from '@ant-design/icons-svg/asn/WomanOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(WomanOutlined);
