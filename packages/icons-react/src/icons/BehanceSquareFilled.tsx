...
import BehanceSquareFilledSvg from '@ant-design/icons-svg/asn/BehanceSquareFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BehanceSquareFilled);
