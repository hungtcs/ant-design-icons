...
import YuqueOutlinedSvg from '@ant-design/icons-svg/asn/YuqueOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(YuqueOutlined);
