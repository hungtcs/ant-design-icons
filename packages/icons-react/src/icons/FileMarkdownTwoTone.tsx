...
import FileMarkdownTwoToneSvg from '@ant-design/icons-svg/asn/FileMarkdownTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileMarkdownTwoTone);
