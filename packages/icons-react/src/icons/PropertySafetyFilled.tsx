...
import PropertySafetyFilledSvg from '@ant-design/icons-svg/asn/PropertySafetyFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PropertySafetyFilled);
