...
import ExceptionOutlinedSvg from '@ant-design/icons-svg/asn/ExceptionOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ExceptionOutlined);
