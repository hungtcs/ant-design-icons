...
import PoweroffOutlinedSvg from '@ant-design/icons-svg/asn/PoweroffOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PoweroffOutlined);
