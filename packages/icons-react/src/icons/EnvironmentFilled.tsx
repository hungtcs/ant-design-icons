...
import EnvironmentFilledSvg from '@ant-design/icons-svg/asn/EnvironmentFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(EnvironmentFilled);
