...
import AliwangwangFilledSvg from '@ant-design/icons-svg/asn/AliwangwangFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AliwangwangFilled);
