...
import UsergroupDeleteOutlinedSvg from '@ant-design/icons-svg/asn/UsergroupDeleteOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(UsergroupDeleteOutlined);
