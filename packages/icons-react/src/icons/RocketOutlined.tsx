...
import RocketOutlinedSvg from '@ant-design/icons-svg/asn/RocketOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RocketOutlined);
