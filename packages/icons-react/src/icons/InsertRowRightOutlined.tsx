...
import InsertRowRightOutlinedSvg from '@ant-design/icons-svg/asn/InsertRowRightOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(InsertRowRightOutlined);
