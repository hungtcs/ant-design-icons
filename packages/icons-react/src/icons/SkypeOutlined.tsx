...
import SkypeOutlinedSvg from '@ant-design/icons-svg/asn/SkypeOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SkypeOutlined);
