...
import FileJpgOutlinedSvg from '@ant-design/icons-svg/asn/FileJpgOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileJpgOutlined);
