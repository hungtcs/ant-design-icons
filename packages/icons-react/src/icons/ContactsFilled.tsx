...
import ContactsFilledSvg from '@ant-design/icons-svg/asn/ContactsFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ContactsFilled);
