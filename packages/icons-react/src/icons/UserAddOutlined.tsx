...
import UserAddOutlinedSvg from '@ant-design/icons-svg/asn/UserAddOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(UserAddOutlined);
