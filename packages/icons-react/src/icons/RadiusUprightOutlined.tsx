...
import RadiusUprightOutlinedSvg from '@ant-design/icons-svg/asn/RadiusUprightOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RadiusUprightOutlined);
