...
import BorderHorizontalOutlinedSvg from '@ant-design/icons-svg/asn/BorderHorizontalOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BorderHorizontalOutlined);
