...
import AlipayOutlinedSvg from '@ant-design/icons-svg/asn/AlipayOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AlipayOutlined);
