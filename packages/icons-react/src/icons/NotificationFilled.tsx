...
import NotificationFilledSvg from '@ant-design/icons-svg/asn/NotificationFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(NotificationFilled);
