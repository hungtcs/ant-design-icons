...
import FullscreenOutlinedSvg from '@ant-design/icons-svg/asn/FullscreenOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FullscreenOutlined);
