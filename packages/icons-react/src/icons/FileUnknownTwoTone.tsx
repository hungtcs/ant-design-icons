...
import FileUnknownTwoToneSvg from '@ant-design/icons-svg/asn/FileUnknownTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileUnknownTwoTone);
