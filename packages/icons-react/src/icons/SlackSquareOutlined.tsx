...
import SlackSquareOutlinedSvg from '@ant-design/icons-svg/asn/SlackSquareOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SlackSquareOutlined);
