...
import DribbbleCircleFilledSvg from '@ant-design/icons-svg/asn/DribbbleCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DribbbleCircleFilled);
