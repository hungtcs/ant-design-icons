...
import DollarCircleOutlinedSvg from '@ant-design/icons-svg/asn/DollarCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DollarCircleOutlined);
