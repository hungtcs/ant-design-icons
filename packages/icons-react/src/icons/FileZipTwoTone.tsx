...
import FileZipTwoToneSvg from '@ant-design/icons-svg/asn/FileZipTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileZipTwoTone);
