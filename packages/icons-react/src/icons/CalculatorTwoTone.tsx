...
import CalculatorTwoToneSvg from '@ant-design/icons-svg/asn/CalculatorTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CalculatorTwoTone);
