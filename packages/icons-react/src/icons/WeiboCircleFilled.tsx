...
import WeiboCircleFilledSvg from '@ant-design/icons-svg/asn/WeiboCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(WeiboCircleFilled);
