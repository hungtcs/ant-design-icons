...
import SoundOutlinedSvg from '@ant-design/icons-svg/asn/SoundOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SoundOutlined);
