...
import AccountBookTwoToneSvg from '@ant-design/icons-svg/asn/AccountBookTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AccountBookTwoTone);
