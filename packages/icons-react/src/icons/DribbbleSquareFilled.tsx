...
import DribbbleSquareFilledSvg from '@ant-design/icons-svg/asn/DribbbleSquareFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DribbbleSquareFilled);
