...
import CompassTwoToneSvg from '@ant-design/icons-svg/asn/CompassTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CompassTwoTone);
