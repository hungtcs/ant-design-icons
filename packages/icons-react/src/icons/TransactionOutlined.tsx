...
import TransactionOutlinedSvg from '@ant-design/icons-svg/asn/TransactionOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(TransactionOutlined);
