...
import DeploymentUnitOutlinedSvg from '@ant-design/icons-svg/asn/DeploymentUnitOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DeploymentUnitOutlined);
