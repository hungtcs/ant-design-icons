...
import MedicineBoxTwoToneSvg from '@ant-design/icons-svg/asn/MedicineBoxTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MedicineBoxTwoTone);
