...
import FieldBinaryOutlinedSvg from '@ant-design/icons-svg/asn/FieldBinaryOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FieldBinaryOutlined);
