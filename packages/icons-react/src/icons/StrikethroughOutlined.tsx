...
import StrikethroughOutlinedSvg from '@ant-design/icons-svg/asn/StrikethroughOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(StrikethroughOutlined);
