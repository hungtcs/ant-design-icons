...
import CarryOutTwoToneSvg from '@ant-design/icons-svg/asn/CarryOutTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CarryOutTwoTone);
