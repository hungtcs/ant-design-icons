...
import PaperClipOutlinedSvg from '@ant-design/icons-svg/asn/PaperClipOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PaperClipOutlined);
