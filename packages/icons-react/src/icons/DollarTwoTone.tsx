...
import DollarTwoToneSvg from '@ant-design/icons-svg/asn/DollarTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DollarTwoTone);
