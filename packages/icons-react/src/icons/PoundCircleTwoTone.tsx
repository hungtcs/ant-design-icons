...
import PoundCircleTwoToneSvg from '@ant-design/icons-svg/asn/PoundCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PoundCircleTwoTone);
