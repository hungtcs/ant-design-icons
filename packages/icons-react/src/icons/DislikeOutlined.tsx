...
import DislikeOutlinedSvg from '@ant-design/icons-svg/asn/DislikeOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DislikeOutlined);
