...
import SlidersTwoToneSvg from '@ant-design/icons-svg/asn/SlidersTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SlidersTwoTone);
