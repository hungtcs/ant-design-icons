...
import CalculatorFilledSvg from '@ant-design/icons-svg/asn/CalculatorFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CalculatorFilled);
