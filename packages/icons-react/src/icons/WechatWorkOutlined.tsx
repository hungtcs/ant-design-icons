...
import WechatWorkOutlinedSvg from '@ant-design/icons-svg/asn/WechatWorkOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(WechatWorkOutlined);
