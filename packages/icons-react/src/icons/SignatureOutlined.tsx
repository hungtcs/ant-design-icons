...
import SignatureOutlinedSvg from '@ant-design/icons-svg/asn/SignatureOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SignatureOutlined);
