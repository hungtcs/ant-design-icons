...
import InstagramOutlinedSvg from '@ant-design/icons-svg/asn/InstagramOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(InstagramOutlined);
