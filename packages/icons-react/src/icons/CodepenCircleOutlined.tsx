...
import CodepenCircleOutlinedSvg from '@ant-design/icons-svg/asn/CodepenCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CodepenCircleOutlined);
