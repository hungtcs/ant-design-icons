...
import UserSwitchOutlinedSvg from '@ant-design/icons-svg/asn/UserSwitchOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(UserSwitchOutlined);
