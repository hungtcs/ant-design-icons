...
import ContactsTwoToneSvg from '@ant-design/icons-svg/asn/ContactsTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ContactsTwoTone);
