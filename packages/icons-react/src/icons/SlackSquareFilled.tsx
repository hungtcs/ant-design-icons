...
import SlackSquareFilledSvg from '@ant-design/icons-svg/asn/SlackSquareFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SlackSquareFilled);
