...
import CloseSquareTwoToneSvg from '@ant-design/icons-svg/asn/CloseSquareTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CloseSquareTwoTone);
