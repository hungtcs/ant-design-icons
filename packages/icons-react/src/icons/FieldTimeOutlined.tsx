...
import FieldTimeOutlinedSvg from '@ant-design/icons-svg/asn/FieldTimeOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FieldTimeOutlined);
