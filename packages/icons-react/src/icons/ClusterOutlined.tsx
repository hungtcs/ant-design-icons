...
import ClusterOutlinedSvg from '@ant-design/icons-svg/asn/ClusterOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ClusterOutlined);
