...
import PropertySafetyOutlinedSvg from '@ant-design/icons-svg/asn/PropertySafetyOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PropertySafetyOutlined);
