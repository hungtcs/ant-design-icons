...
import CiCircleTwoToneSvg from '@ant-design/icons-svg/asn/CiCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CiCircleTwoTone);
