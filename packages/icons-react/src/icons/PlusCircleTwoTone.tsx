...
import PlusCircleTwoToneSvg from '@ant-design/icons-svg/asn/PlusCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PlusCircleTwoTone);
