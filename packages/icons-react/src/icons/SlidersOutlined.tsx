...
import SlidersOutlinedSvg from '@ant-design/icons-svg/asn/SlidersOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SlidersOutlined);
