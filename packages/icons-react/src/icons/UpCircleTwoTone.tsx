...
import UpCircleTwoToneSvg from '@ant-design/icons-svg/asn/UpCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(UpCircleTwoTone);
