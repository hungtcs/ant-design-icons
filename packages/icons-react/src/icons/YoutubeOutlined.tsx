...
import YoutubeOutlinedSvg from '@ant-design/icons-svg/asn/YoutubeOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(YoutubeOutlined);
