...
import CopyrightTwoToneSvg from '@ant-design/icons-svg/asn/CopyrightTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CopyrightTwoTone);
