...
import TikTokOutlinedSvg from '@ant-design/icons-svg/asn/TikTokOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(TikTokOutlined);
