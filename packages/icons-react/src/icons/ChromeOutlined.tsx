...
import ChromeOutlinedSvg from '@ant-design/icons-svg/asn/ChromeOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ChromeOutlined);
