...
import FileTextTwoToneSvg from '@ant-design/icons-svg/asn/FileTextTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileTextTwoTone);
