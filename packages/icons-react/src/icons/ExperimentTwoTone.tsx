...
import ExperimentTwoToneSvg from '@ant-design/icons-svg/asn/ExperimentTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ExperimentTwoTone);
