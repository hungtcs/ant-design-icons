...
import FileExcelTwoToneSvg from '@ant-design/icons-svg/asn/FileExcelTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileExcelTwoTone);
