...
import FrownOutlinedSvg from '@ant-design/icons-svg/asn/FrownOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FrownOutlined);
