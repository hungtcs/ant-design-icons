...
import HourglassTwoToneSvg from '@ant-design/icons-svg/asn/HourglassTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(HourglassTwoTone);
