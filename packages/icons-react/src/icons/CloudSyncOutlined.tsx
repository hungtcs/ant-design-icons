...
import CloudSyncOutlinedSvg from '@ant-design/icons-svg/asn/CloudSyncOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CloudSyncOutlined);
