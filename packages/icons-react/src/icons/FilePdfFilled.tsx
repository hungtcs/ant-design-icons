...
import FilePdfFilledSvg from '@ant-design/icons-svg/asn/FilePdfFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FilePdfFilled);
