...
import AlipayCircleFilledSvg from '@ant-design/icons-svg/asn/AlipayCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AlipayCircleFilled);
