...
import PropertySafetyTwoToneSvg from '@ant-design/icons-svg/asn/PropertySafetyTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PropertySafetyTwoTone);
