...
import PinterestFilledSvg from '@ant-design/icons-svg/asn/PinterestFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PinterestFilled);
