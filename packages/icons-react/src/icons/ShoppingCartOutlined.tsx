...
import ShoppingCartOutlinedSvg from '@ant-design/icons-svg/asn/ShoppingCartOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ShoppingCartOutlined);
