...
import VerifiedOutlinedSvg from '@ant-design/icons-svg/asn/VerifiedOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(VerifiedOutlined);
