...
import FieldStringOutlinedSvg from '@ant-design/icons-svg/asn/FieldStringOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FieldStringOutlined);
