...
import FullscreenExitOutlinedSvg from '@ant-design/icons-svg/asn/FullscreenExitOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FullscreenExitOutlined);
