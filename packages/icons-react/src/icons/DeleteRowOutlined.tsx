...
import DeleteRowOutlinedSvg from '@ant-design/icons-svg/asn/DeleteRowOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DeleteRowOutlined);
