...
import UngroupOutlinedSvg from '@ant-design/icons-svg/asn/UngroupOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(UngroupOutlined);
