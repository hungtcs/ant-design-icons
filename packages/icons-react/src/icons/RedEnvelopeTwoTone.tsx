...
import RedEnvelopeTwoToneSvg from '@ant-design/icons-svg/asn/RedEnvelopeTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RedEnvelopeTwoTone);
