...
import RightCircleOutlinedSvg from '@ant-design/icons-svg/asn/RightCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RightCircleOutlined);
