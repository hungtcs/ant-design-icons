...
import ReconciliationTwoToneSvg from '@ant-design/icons-svg/asn/ReconciliationTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ReconciliationTwoTone);
