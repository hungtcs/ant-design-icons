...
import FileGifOutlinedSvg from '@ant-design/icons-svg/asn/FileGifOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileGifOutlined);
