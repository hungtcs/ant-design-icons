...
import BilibiliFilledSvg from '@ant-design/icons-svg/asn/BilibiliFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BilibiliFilled);
