...
import CalculatorOutlinedSvg from '@ant-design/icons-svg/asn/CalculatorOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CalculatorOutlined);
