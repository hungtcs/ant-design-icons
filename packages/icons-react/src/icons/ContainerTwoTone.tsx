...
import ContainerTwoToneSvg from '@ant-design/icons-svg/asn/ContainerTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ContainerTwoTone);
