...
import ReloadOutlinedSvg from '@ant-design/icons-svg/asn/ReloadOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ReloadOutlined);
