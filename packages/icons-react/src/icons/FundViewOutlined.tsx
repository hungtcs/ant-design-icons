...
import FundViewOutlinedSvg from '@ant-design/icons-svg/asn/FundViewOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FundViewOutlined);
