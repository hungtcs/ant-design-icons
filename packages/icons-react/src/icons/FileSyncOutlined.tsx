...
import FileSyncOutlinedSvg from '@ant-design/icons-svg/asn/FileSyncOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileSyncOutlined);
