...
import CloseSquareFilledSvg from '@ant-design/icons-svg/asn/CloseSquareFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CloseSquareFilled);
