...
import CoffeeOutlinedSvg from '@ant-design/icons-svg/asn/CoffeeOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CoffeeOutlined);
