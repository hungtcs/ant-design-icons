...
import ConsoleSqlOutlinedSvg from '@ant-design/icons-svg/asn/ConsoleSqlOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ConsoleSqlOutlined);
