...
import LoginOutlinedSvg from '@ant-design/icons-svg/asn/LoginOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(LoginOutlined);
