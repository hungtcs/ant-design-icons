...
import InteractionTwoToneSvg from '@ant-design/icons-svg/asn/InteractionTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(InteractionTwoTone);
