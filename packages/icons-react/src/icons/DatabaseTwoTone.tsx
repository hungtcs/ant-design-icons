...
import DatabaseTwoToneSvg from '@ant-design/icons-svg/asn/DatabaseTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DatabaseTwoTone);
