...
import PythonOutlinedSvg from '@ant-design/icons-svg/asn/PythonOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PythonOutlined);
