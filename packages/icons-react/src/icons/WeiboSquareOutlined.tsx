...
import WeiboSquareOutlinedSvg from '@ant-design/icons-svg/asn/WeiboSquareOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(WeiboSquareOutlined);
