...
import SlackCircleFilledSvg from '@ant-design/icons-svg/asn/SlackCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SlackCircleFilled);
