...
import AlipayCircleOutlinedSvg from '@ant-design/icons-svg/asn/AlipayCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AlipayCircleOutlined);
