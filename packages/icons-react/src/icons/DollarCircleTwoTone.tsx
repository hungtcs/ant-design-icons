...
import DollarCircleTwoToneSvg from '@ant-design/icons-svg/asn/DollarCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DollarCircleTwoTone);
