...
import ProjectTwoToneSvg from '@ant-design/icons-svg/asn/ProjectTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ProjectTwoTone);
