...
import BorderInnerOutlinedSvg from '@ant-design/icons-svg/asn/BorderInnerOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(BorderInnerOutlined);
