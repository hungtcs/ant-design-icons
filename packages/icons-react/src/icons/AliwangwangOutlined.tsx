...
import AliwangwangOutlinedSvg from '@ant-design/icons-svg/asn/AliwangwangOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AliwangwangOutlined);
