...
import MonitorOutlinedSvg from '@ant-design/icons-svg/asn/MonitorOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MonitorOutlined);
