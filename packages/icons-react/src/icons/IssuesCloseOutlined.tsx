...
import IssuesCloseOutlinedSvg from '@ant-design/icons-svg/asn/IssuesCloseOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(IssuesCloseOutlined);
