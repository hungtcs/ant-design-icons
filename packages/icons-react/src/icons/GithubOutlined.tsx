...
import GithubOutlinedSvg from '@ant-design/icons-svg/asn/GithubOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(GithubOutlined);
