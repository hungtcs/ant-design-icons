...
import CloudDownloadOutlinedSvg from '@ant-design/icons-svg/asn/CloudDownloadOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CloudDownloadOutlined);
