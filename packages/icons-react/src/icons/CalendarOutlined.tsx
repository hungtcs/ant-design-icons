...
import CalendarOutlinedSvg from '@ant-design/icons-svg/asn/CalendarOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CalendarOutlined);
