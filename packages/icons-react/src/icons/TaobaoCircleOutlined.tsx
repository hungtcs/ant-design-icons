...
import TaobaoCircleOutlinedSvg from '@ant-design/icons-svg/asn/TaobaoCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(TaobaoCircleOutlined);
