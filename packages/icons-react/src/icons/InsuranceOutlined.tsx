...
import InsuranceOutlinedSvg from '@ant-design/icons-svg/asn/InsuranceOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(InsuranceOutlined);
