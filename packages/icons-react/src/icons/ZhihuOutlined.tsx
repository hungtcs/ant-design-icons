...
import ZhihuOutlinedSvg from '@ant-design/icons-svg/asn/ZhihuOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ZhihuOutlined);
