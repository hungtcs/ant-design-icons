...
import DockerOutlinedSvg from '@ant-design/icons-svg/asn/DockerOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DockerOutlined);
