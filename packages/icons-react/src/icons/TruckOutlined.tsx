...
import TruckOutlinedSvg from '@ant-design/icons-svg/asn/TruckOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(TruckOutlined);
