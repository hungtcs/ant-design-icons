...
import CopyrightCircleTwoToneSvg from '@ant-design/icons-svg/asn/CopyrightCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CopyrightCircleTwoTone);
