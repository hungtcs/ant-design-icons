...
import UserDeleteOutlinedSvg from '@ant-design/icons-svg/asn/UserDeleteOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(UserDeleteOutlined);
