...
import HistoryOutlinedSvg from '@ant-design/icons-svg/asn/HistoryOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(HistoryOutlined);
