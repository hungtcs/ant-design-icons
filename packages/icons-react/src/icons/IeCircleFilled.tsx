...
import IeCircleFilledSvg from '@ant-design/icons-svg/asn/IeCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(IeCircleFilled);
