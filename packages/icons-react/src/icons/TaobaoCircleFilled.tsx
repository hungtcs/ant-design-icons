...
import TaobaoCircleFilledSvg from '@ant-design/icons-svg/asn/TaobaoCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(TaobaoCircleFilled);
