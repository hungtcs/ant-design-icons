...
import FileWordTwoToneSvg from '@ant-design/icons-svg/asn/FileWordTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileWordTwoTone);
