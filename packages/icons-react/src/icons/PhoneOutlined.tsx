...
import PhoneOutlinedSvg from '@ant-design/icons-svg/asn/PhoneOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(PhoneOutlined);
