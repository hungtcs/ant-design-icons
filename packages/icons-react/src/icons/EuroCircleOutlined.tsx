...
import EuroCircleOutlinedSvg from '@ant-design/icons-svg/asn/EuroCircleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(EuroCircleOutlined);
