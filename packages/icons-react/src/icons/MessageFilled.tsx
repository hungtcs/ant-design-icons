...
import MessageFilledSvg from '@ant-design/icons-svg/asn/MessageFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(MessageFilled);
