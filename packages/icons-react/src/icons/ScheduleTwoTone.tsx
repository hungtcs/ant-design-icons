...
import ScheduleTwoToneSvg from '@ant-design/icons-svg/asn/ScheduleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ScheduleTwoTone);
