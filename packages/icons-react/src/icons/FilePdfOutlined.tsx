...
import FilePdfOutlinedSvg from '@ant-design/icons-svg/asn/FilePdfOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FilePdfOutlined);
