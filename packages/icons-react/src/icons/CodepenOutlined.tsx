...
import CodepenOutlinedSvg from '@ant-design/icons-svg/asn/CodepenOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(CodepenOutlined);
