...
import SignatureFilledSvg from '@ant-design/icons-svg/asn/SignatureFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(SignatureFilled);
