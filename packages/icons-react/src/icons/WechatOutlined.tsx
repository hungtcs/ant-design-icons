...
import WechatOutlinedSvg from '@ant-design/icons-svg/asn/WechatOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(WechatOutlined);
