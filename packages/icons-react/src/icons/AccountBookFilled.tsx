...
import AccountBookFilledSvg from '@ant-design/icons-svg/asn/AccountBookFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(AccountBookFilled);
