...
import RightCircleTwoToneSvg from '@ant-design/icons-svg/asn/RightCircleTwoTone';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(RightCircleTwoTone);
