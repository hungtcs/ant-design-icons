...
import DribbbleOutlinedSvg from '@ant-design/icons-svg/asn/DribbbleOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(DribbbleOutlined);
