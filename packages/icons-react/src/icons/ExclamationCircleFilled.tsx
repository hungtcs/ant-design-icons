...
import ExclamationCircleFilledSvg from '@ant-design/icons-svg/asn/ExclamationCircleFilled';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(ExclamationCircleFilled);
