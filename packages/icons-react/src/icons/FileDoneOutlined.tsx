...
import FileDoneOutlinedSvg from '@ant-design/icons-svg/asn/FileDoneOutlined';
...
const RefIcon = React.forwardRef<HTMLSpanElement, Omit<AntdIconProps, 'ref'>>(FileDoneOutlined);
